...
#define TCTL_EVENT_STREAM_CONTROLLER_WAIT   (5)
#define TCTL_EVENT_STREAM_DETACHED          (6)
#define TCTL_EVENT_STREAM_CLOSED            (7)
#define TCTL_EVENT_STREAM_FAILED            (8)
#define TCTL_EVENT_STC_ENOUGH_DIR_INFO      (9)
#define TCTL_EVENT_OTHER                    (99)

#define TCTL_STREAM_REASON_DONE             (0)
#define TCTL_STREAM_REASON_TIMEOUT          (1)
#define TCTL_STREAM_REASON_END              (2)
#define TCTL_STREAM_REASON_OTHER            (99)
